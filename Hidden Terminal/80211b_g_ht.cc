...
//for(uint32_t i=0;i<=1;i++){
  ...
  wifiChannel->SetPropagationDelayModel (CreateObject <ConstantSpeedPropagationDelayModel> ());
   ...
   WifiHelper wifi;
    wifi.SetStandard (standard);			// standard is 802.11b and 802.11g
    if (standard == WIFI_PHY_STANDARD_80211b || standard == WIFI_PHY_STANDARD_80211g)	// using DSSS Rate 2Mbps
    {
...
int main (int argc, char **argv)
{
 ...
 for(int i=0;i<2;i++){
   if(i==0){
	...
	std::cout << "WiFi Standard of 802.11b \n" ;
    std::cout << "---------------------------------------\n";   
   
    std::cout << "Station nodes: 3 \n" << std::flush;
    output = stand_a (0,WIFI_PHY_STANDARD_80211b);
    std::cout << "Throughput: " << output << " Mbit/s" << '\n';
    std::cout << "---------------------------------------\n";
	std::cout << "\n";
	std::cout << "\n"; 
	
    std::cout << "WiFi Standard of 802.11g \n" ;
    std::cout << "---------------------------------------\n";
     
    std::cout << "Station nodes: 3 \n" << std::flush;
    output = stand_a (0,WIFI_PHY_STANDARD_80211g);
    std::cout << "Throughput: " << output << " Mbit/s" << '\n';
    std::cout << "---------------------------------------\n";
    std::cout << "\n";
   }
    ...
    std::cout << "Station nodes: 3 \n" << std::flush;
    output = stand_a (1,WIFI_PHY_STANDARD_80211b);
    std::cout << "Throughput: " << output << " Mbit/s" << '\n';
    std::cout << "---------------------------------------\n";
	std::cout << "\n";
	std::cout << "\n"; 
    ...
    std::cout << "Station nodes: 3 \n" << std::flush;
    output = stand_a (1,WIFI_PHY_STANDARD_80211g);
    std::cout << "Throughput: " << output << " Mbit/s" << '\n';
    std::cout << "---------------------------------------\n";
	std::cout << "\n";
   }
