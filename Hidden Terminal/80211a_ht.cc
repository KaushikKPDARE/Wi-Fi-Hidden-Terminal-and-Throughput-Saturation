...
//for(uint32_t i=0;i<=1;i++){
  ...
  wifiChannel->SetPropagationDelayModel (CreateObject <ConstantSpeedPropagationDelayModel> ());
   ...
   WifiHelper wifi;
    ...
    if (standard == WIFI_PHY_STANDARD_80211a)	// using OFDM Rate 6Mbps
    {
...
int main (int argc, char **argv)
{
 ...
 for(int i=0;i<2;i++){
   if(i==0){
	...
	std::cout << "WiFi Standard of 802.11a \n" ;
    std::cout << "---------------------------------------\n";   
   
    std::cout << "Station nodes: 3 \n" << std::flush;
    output = stand_a (0,WIFI_PHY_STANDARD_80211a);
    ...
    std::cout << "Station nodes: 3 \n" << std::flush;
    output = stand_a (1,WIFI_PHY_STANDARD_80211a);
    std::cout << "Throughput: " << output << " Mbit/s" << '\n';
    std::cout << "---------------------------------------\n";
	std::cout << "\n";
  }
