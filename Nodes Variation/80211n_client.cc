...
//wifi standanrd 802.11n without hidden terminal when number of clients change
//Author: Kaushik, Umesh, John
...
{        
    ...
    std::cout << "WiFi standard 802.11n for 5GHz frequency\n";
    std::cout << "---------------------------------------\n";
     
    std::cout << " cbr rate = 2Mbps\n" << std::flush;
    output = stand_a (3, WIFI_PHY_STANDARD_80211n_5GHZ, "2Mbps");
    std::cout << "throughput: " << output << "\n";
    std::cout << "---------------------------------------\n";
        
    std::cout << " cbr rate = 2Mbps \n" << std::flush;
    output = stand_a (6, WIFI_PHY_STANDARD_80211n_5GHZ, "2Mbps");
    std::cout << "throughput: " << output << "\n";
    std::cout << "---------------------------------------\n";
       
    std::cout << " cbr rate = 2Mbps \n" << std::flush;
    output = stand_a (9, WIFI_PHY_STANDARD_80211n_5GHZ, "2Mbps");
    std::cout << "throughput: " << output << "\n";
    std::cout << "---------------------------------------\n";
        
    std::cout << " cbr rate = 2Mbps \n" << std::flush;
    output = stand_a (12, WIFI_PHY_STANDARD_80211n_5GHZ, "2Mbps");
    std::cout << "throughput: " << output << "\n";
    std::cout << "---------------------------------------\n";
    
    std::cout <<" \n";
    std::cout <<"WiFi standard 802.11n for 2.4GHZ frequency\n";
    std::cout <<" -----------------------------------\n";
    
    std::cout << " cbr rate = 2Mbps\n" << std::flush;
    output = stand_a (3, WIFI_PHY_STANDARD_80211n_2_4GHZ, "2Mbps");
    std::cout << "throughput: " << output << "\n";
    std::cout << "---------------------------------------\n";
     
    std::cout << " cbr rate = 2Mbps\n" << std::flush;
    output = stand_a (6, WIFI_PHY_STANDARD_80211n_2_4GHZ, "2Mbps");
    std::cout << "throughput: " << output << "\n";
    std::cout << "---------------------------------------\n";
          
    std::cout << " cbr rate = 2Mbps\n" << std::flush;
    output = stand_a (9, WIFI_PHY_STANDARD_80211n_2_4GHZ, "2Mbps");
    std::cout << "throughput: " << output << "\n";
    std::cout << "---------------------------------------\n";
         
    std::cout << " cbr rate = 2Mbps\n" << std::flush;
    output = stand_a (12, WIFI_PHY_STANDARD_80211n_2_4GHZ, "2Mbps");
    std::cout << "throughput: " << output << "\n";
    std::cout << "---------------------------------------\n";
