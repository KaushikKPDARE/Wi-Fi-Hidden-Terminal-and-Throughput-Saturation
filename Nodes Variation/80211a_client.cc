...
// wifi standanrd 802.11a without hidden terminal 
...
{   
    ...
    WifiHelper wifi;
    wifi.SetStandard (standard);			// standard is 802.11a
...
int main (int argc, char **argv)
{
    ...
    std::cout << " client nodes are increased for 802.11a standard to check saturation \n" ;
    std::cout << "cbr rate 2Mbps \n";
    std::cout << "---------------------------------------\n";
     
    std::cout << " station nodes 3 \n" << std::flush;
    output = stand_a (3, WIFI_PHY_STANDARD_80211a, "2Mbps");
    std::cout << "throughput: " << output << "\n";
    std::cout << "---------------------------------------\n";
     
    std::cout << " station nodes 6 \n" << std::flush;
    output = stand_a (6, WIFI_PHY_STANDARD_80211a, "2Mbps");
    std::cout << "throughput: " << output << "\n";
    std::cout << "---------------------------------------\n";
    
    std::cout << " station nodes 9 \n" << std::flush;
    output = stand_a (9, WIFI_PHY_STANDARD_80211a, "2Mbps");
    std::cout << "throughput: " << output << "\n";
    std::cout << "---------------------------------------\n";
      
    std::cout << " station nodes 12 \n" << std::flush;
    output = stand_a (12, WIFI_PHY_STANDARD_80211a, "2Mbps");
    std::cout << "throughput: " << output << "\n";
    std::cout << "---------------------------------------\n";
    return 0;
}